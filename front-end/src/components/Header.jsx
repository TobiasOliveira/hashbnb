    ...
    <div className='shadow-md'>
      <div className='flex items-center justify-between px-4 py-2 max-w-7xl mx-auto'>
        <div className='flex items-center'>
          <img className='h-20' src="https://i.pinimg.com/474x/28/32/25/2832251f86248ec7c38490ffaff30a44.jpg"
          alt="Logo Tobias" />
          <p className='text-orange-500 font-bold'>obias</p>
        </div>
    
        <div className='flex items-center border border-gray-300 pr-4 pl-6 py-2 rounded-full shadow-md'>
          <p className='pr-4 border-r border-r-gray-300 text-gray-600'>Qualquer lugar</p>
          <p className='px-4 border-r border-r-gray-300 text-gray-600'>Qualquer semana</p>
          <p className='px-4 text-gray-600'>Hóspedes</p>
        ...
        <div className='flex items-center border border-gray-300 pr-4 pl-6 py-2 rounded-full shadow-md gap-2'>
          ...
          <p className='text-gray-600'>Tobias Oliveira</p>
        </div>
